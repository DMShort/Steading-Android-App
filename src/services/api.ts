...
export const api = {
  auth: {
    login: (email: string, password: string) =>
      request("/auth/callback/credentials", {
        method: "POST",
  ...
  homestead: {
    ...
    update: (data: object) =>
      request("/homestead", { method: "PATCH", body: JSON.stringify(data) }),
    members: () => request("/homestead/members"),
    join: (joinCode: string, displayName?: string) =>
      request("/homestead/join", {
        method: "POST",
  ...
  beds: {
    list: () => request("/beds"),
    create: (data: object) =>
      request("/beds", { method: "POST", body: JSON.stringify(data) }),
    update: (id: string, data: object) =>
      request(`/beds/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  ...
  produce: {
    list: (days?: number) =>
      request(`/produce${days ? `?days=${days}` : ""}`),
    create: (data: object) =>
      request("/produce", { method: "POST", body: JSON.stringify(data) }),
  },

  harvest: {
    list: () => request("/harvest"),
    create: (data: object) =>
      request("/harvest", { method: "POST", body: JSON.stringify(data) }),
  ...
  seeds: {
    ...
    update: (id: string, data: object) =>
      request(`/seeds/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  ...
  journal: {
    ...
    update: (id: string, data: object) =>
      request(`/journal/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
